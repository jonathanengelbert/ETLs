...
try:
    ...
    file = open("C:/ETLs/TIM/logs/" + myStartDate + "BSP_GreenConnections" + ".txt", "w")
    ...
    # # arcpy.CopyFeatures_management(bsp_sde, staging_gdb + bsp_local_1, "", "0", "0", "0")
    # arcpy.CopyFeatures_management(bsp_sde, staging_gdb + bsp_local_1)
    ...
    ready_folder = "\\\\CP-GIS-SVR1\\arcgisserver\\DataAndMXDs\\TIMReady\\GreenConnections.gdb\\"
    ...
    #deleteandappend("betterstreetsbuffer.shp")
    #file.write(str(time.ctime()) +": deleted and appended local"+ "\n")
    #deleteandappend("greenconnectionsbuffer.shp")
