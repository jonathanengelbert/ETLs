...
try:
    ...
    file = open("C:/ETLs/TIM/Logs/" + myStartDate + "TrafficCalming" + ".txt", "w")
    ...
    stagingfolder = "\\\\CP-GIS-SVR1\\arcgisserver\\DataAndMXDs\\TIMReady\\TrafficCalming.gdb\\"
    ...
    print zf.namelist()
    tempfolder = "\\\\CP-GIS-SVR1\\arcgisserver\\DataAndMXDs\\TIMSReady\\zip\\TC\\"
